...
class JournalEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journal_entry" do
    assert_difference('JournalEntry.count') do
      post journal_entries_url, params: { journal_entry: { emotion: @journal_entry.emotion, keywords: @journal_entry.keywords } }
    end
  ...
  test "should update journal_entry" do
    patch journal_entry_url(@journal_entry), params: { journal_entry: { emotion: @journal_entry.emotion, keywords: @journal_entry.keywords } }
